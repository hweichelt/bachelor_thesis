...
BENCHMARK_DIRS = [
    "../benchmarks/muc_scaling/40_assumptions/1_mucs",
    "../benchmarks/muc_scaling/40_assumptions/2_mucs",
    "../benchmarks/muc_scaling/40_assumptions/3_mucs",
    "../benchmarks/muc_scaling/40_assumptions/4_mucs",
    "../benchmarks/muc_scaling/40_assumptions/5_mucs",
    "../benchmarks/muc_scaling/40_assumptions/6_mucs",
    "../benchmarks/muc_scaling/40_assumptions/7_mucs",
    "../benchmarks/muc_scaling/40_assumptions/8_mucs",
    "../benchmarks/muc_scaling/40_assumptions/9_mucs",
    "../benchmarks/muc_scaling/40_assumptions/10_mucs",
]

# ID MUC SCALING
BENCHMARK_DIRS = [
    "../benchmarks/muc_scaling_id/4000_assumptions/1000_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/1200_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/1400_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/1600_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/1800_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/2000_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/2200_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/2400_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/2600_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/2800_mucs",
    "../benchmarks/muc_scaling_id/4000_assumptions/3000_mucs",
]

# ASSUMPTION SCALING BENCHMARKS
BENCHMARK_DIRS = [
    "../benchmarks/assumption_scaling/10_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/20_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/30_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/40_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/50_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/60_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/70_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/80_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/90_assumptions/5_mucs",
    "../benchmarks/assumption_scaling/100_assumptions/5_mucs",
]

# ID ASSUMPTION SCALING BENCHMARKS
BENCHMARK_DIRS = [
    "../benchmarks/assumption_scaling_id/1000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/2000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/3000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/4000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/5000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/6000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/7000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/8000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/9000_assumptions/10_mucs",
    "../benchmarks/assumption_scaling_id/10000_assumptions/10_mucs",
]
